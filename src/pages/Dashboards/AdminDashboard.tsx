...
const AdminDashboard: React.FC = () => {
  ...
  const recentActivity = [
    { id: 1, type: 'user_registration', message: 'New member John Doe registered', time: '2 minutes ago' },
    { id: 2, type: 'booking_completed', message: 'Booking #3456 completed successfully', time: '15 minutes ago' },
    { id: 3, type: 'mentor_joined', message: 'New mentor Sarah Wilson joined', time: '1 hour ago' },
    { id: 4, type: 'system_update', message: 'System maintenance completed', time: '2 hours ago' },
  ];
  ...
  const getActivityIcon = (type: string) => {
    switch (type) {
      ...
      case 'mentor_joined':
        return <UserCheck className="w-4 h-4 text-orange-600 dark:text-orange-400" />;
      case 'system_update':
        return <Settings className="w-4 h-4 text-purple-600 dark:text-purple-400" />;
      default:
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6 border border-gray-100 dark:border-gray-700">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-orange-600 dark:text-orange-400 mt-1">↗ +5 this month</p>
              </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6 border border-gray-100 dark:border-gray-700">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center justify-between">
                ...
                <span className="font-semibold text-gray-900 dark:text-white">{stats.totalMentors}</span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-gray-600 dark:text-gray-400">Admins</span>
                <span className="font-semibold text-gray-900 dark:text-white">{stats.totalAdmins}</span>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6 border border-gray-100 dark:border-gray-700">
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                ...
                <span className="font-semibold text-green-600 dark:text-green-400">{stats.completedBookings}</span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-gray-600 dark:text-gray-400">Active</span>
                <span className="font-semibold text-blue-600 dark:text-blue-400">{stats.activeBookings}</span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-gray-600 dark:text-gray-400">Pending</span>
                <span className="font-semibold text-yellow-600 dark:text-yellow-400">{stats.pendingBookings}</span>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6 border border-gray-100 dark:border-gray-700">
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                ...
                <span className="font-semibold text-green-600 dark:text-green-400">{stats.serverUptime}%</span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-gray-600 dark:text-gray-400">Health Score</span>
                <span className="font-semibold text-green-600 dark:text-green-400">{stats.systemHealth}%</span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-gray-600 dark:text-gray-400">Last Backup</span>
                <span className="font-semibold text-gray-900 dark:text-white">2h ago</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="mt-8 bg-gradient-to-r from-orange-500 to-orange-600 rounded-xl shadow-md p-6">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            <div className="text-white">
              ...
              <p className="text-orange-100">Manage your platform efficiently</p>
            </div>
